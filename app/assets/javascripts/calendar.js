...
(function($) {
	...
	Calendar.prototype.navigate = function(where, next) {
		...
		if(where == 'next') {
			...
			console.error(this.locale.error_where.format(where))
		}
	...
	Calendar.prototype._init_position = function() {
		...
		if(this.options.day == 'now') {
			...
			console.error(this.locale.error_dateformat.format(this.options.day));
		}
		...
		switch(this.options.view) {
			...
			case 'week':
				...
				break;
			default:
				console.error(this.locale.error_noview.format(this.options.view))
		}
		return this;
	};
	...
	Calendar.prototype._loadEvents = function() {
		...
		if(!loader) {
			console.error(this.locale.error_loadurl);
		}
